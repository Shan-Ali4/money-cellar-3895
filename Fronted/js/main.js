let bannerList = [
    ...
    {
        imgUrl: "https://cdn01.pharmeasy.in/dam/banner/banner/f945f162d91-primaryhp.jpg"
    }
];
...
let newLaunchesList = [
    ...
    {
        name: "Similac Plus Infant Formula With Added Dha & Vitamin E Stage 2 400gm Tin (Between 6-12 Months)",
    ...
    },
    {
        ...
        imgUrl: "https://cdn01.pharmeasy.in/dam/products_otc/U27961/similac-plus-infant-formula-with-added-dha-vitamin-e-stage-2-400gm-tin-between-6-12-months-2-1656685393.jpg?dim=1440x0",
        mrp: 149,
        discount: 5,
    },
    {
    ...
    {
        name: "Colgate Slimsoft Charcoal Manual Toothbrush For Adults (Buy 2, Get 2 Free) - 4 Pcs",
        imgUrl: "https://cdn01.pharmeasy.in/dam/products_otc/G26171/colgate-slimsoft-charcoal-manual-toothbrush-for-adults-buy-2-get-2-free-4-pcs-2-1674204099.jpg?dim=1440x0",
        mrp: 185,
        discount: 0,
    },
    {
        name: "Charmis Moisturising Cold Cream- 58 Ml",
        imgUrl: "https://cdn01.pharmeasy.in/dam/products_otc/P03437/charmis-moisturising-cold-cream-58-ml-2-1671742979.jpg?dim=1440x0",
        mrp: 240,
        discount: 25,
    },
    {
        name: "Himalaya Litchi Shine Lip Care Lip Balm 4.5 Gm",
        imgUrl: "https://cdn01.pharmeasy.in/dam/products_otc/Y02253/himalaya-litchi-shine-lip-care-lip-balm-45-gm-2-1653898470.jpg?dim=1440x0",
        mrp: 240,
        discount: 25,
    },
];
...
let healthArticleList = [
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/28134033/321.jpg?dim=1440x0",
        title: "लिम्सी 500 एमजी (Limcee 500mg in Hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/28133854/331.jpg?dim=1024x0",
        title: "पँडर्म ++ क्रीम (Panderm ++cream in hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/28123027/291.jpg?dim=1024x0",
        title: "ज़िफ़ी 200 मि.ग्रा. टैबलेट (Zifi 200mg Tablet in Hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/28122634/281.jpg?dim=1024x0",
        title: "नो स्कार्स क्रीम 20 ग्राम (No Scars Cream 20gm in hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/24134030/261.jpg?dim=1440x0",
        title: "रैनटैक 150 मि.ग्रा. (Rantac 150mg in Hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/03/24133818/271.jpg?dim=1440x0",
        title: "एलेग्रा 120 मि.ग्रा (Allegra 120mg in Hindi): उपयोग, साइड इफेक्ट, खुराक",
    },
];
...
createProductBannerList(freqBookedLabTestContainer,freqBookedLabTestList);
...
let wellEssentialsContainer = document.querySelector(".wellness-essentials > .product-cards2")
createProductlist(wellnessEssentialsList,wellEssentialsContainer)
...
let dealsOfTheDayContainer=document.querySelector(".deal-of-the-day > .product-cards")
...
let spotPromoContainer=document.querySelector(".spotlight > .product-promo")
createOfferList(productPromo,spotPromoContainer)
...
createCustomerrReview(customerReviewList,customerReviewContainer)

function createCustomerrReview(list,container){
...
function createProductBannerList(container, list){
    list.forEach(function(el){
        let div=document.createElement("div")
        let div2=document.createElement("div")
        let img=document.createElement("img")
